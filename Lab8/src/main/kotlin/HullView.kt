...
class HullView {
    ...
    fun drawLine(minY: Double, maxY: Double, x: Double) {
        chart.addSeries("List $x", doubleArrayOf(x, x), doubleArrayOf(minY, maxY)).setMarkerColor(Color.RED)
            .setMarker(SeriesMarkers.CIRCLE).setLineColor(Color.RED)
    }
}